...
private:
	...
	float filtPrevSampIn[8][8][4][2] = {{{{0}}}};// [filter number][port][samples back in time][channel]
	float filtPrevSampOut[8][8][4][2] = {{{{0}}}};// [filter number][port][samples back in time][channel]
