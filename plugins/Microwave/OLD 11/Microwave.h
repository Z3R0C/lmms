...
#define setwavemodel( name )\
		...
		name ->addItem( tr( "Clip" ), make_unique<PluginPixmapLoader>( "saw" ) );\
		name ->addItem( tr( "Inverse Clip" ), make_unique<PluginPixmapLoader>( "ramp" ) );\
...
#define modcombinetypemodel( name )\
		name ->addItem( tr( "Add Unidirectional" ), make_unique<PluginPixmapLoader>( "number_1" ) );\
		name ->addItem( tr( "Multiply Unidirectional" ), make_unique<PluginPixmapLoader>( "number_2" ) );\
		name ->addItem( tr( "Add Bidirectional" ), make_unique<PluginPixmapLoader>( "number_3" ) );\
		name ->addItem( tr( "Multiply Bidirectional" ), make_unique<PluginPixmapLoader>( "number_4" ) );
